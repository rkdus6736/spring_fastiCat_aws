...
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
    ...
    <div class="container_box">
		<div class="container">
		    ...
		    <div class="backMyPage">
			    <div class="writing">
			        <button type="button" name="delete" class="delete" onclick="openPopup('comment')">삭제</button>
			    </div>
			    <!-- 목록으로 돌아가기  - 소연-->
  ...
  <script type="text/javascript">
	...
	function deleteConfirm() {
       ...
       //여기부터 작업
          $.ajax({
        	    url: '${path}/CommentDeleteAction.myp?${_csrf.parameterName}=${_csrf.token}',
	           	 type: 'POST',
	             traditional: true,
	...
	//테이블 토글
     ...
     let param = {
		   ...
		   $.ajax({
	           url :'${path}/myCommentTable.myp?${_csrf.parameterName}=${_csrf.token}' ,         //3.
	           type : 'POST',
	           data : param,                  //요청데이터 형식(html,xml,json,text)
	           success : function(data){      //6. 콜백함수 - 전송성공시의 결과가 result에 전달된다.
